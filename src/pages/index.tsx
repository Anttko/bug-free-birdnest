  ...
  return (
    <div>
      <Heading
        ...
        m={10}
      >
        Drones that violate the NFZ
      </Heading>
      <Text display="flex" justifyContent="center" alignItems="center" m={10}>
        Wait few seconds to refresh the data
      </Text>
      <Dronemap data={data} />
      <Heading
        display="flex"
